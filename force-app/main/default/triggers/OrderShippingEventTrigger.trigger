trigger OrderShippingEventTrigger on Order_Shipping_Event__e (after insert) {

    private Integer processedEventsCounter = 0;
    
    for (Order_Shipping_Event__e event : Trigger.New) {
        try {
            ...
            System.debug('An exception occurred in OrderShippingEventTrigger: ' + e.getTypeName());
